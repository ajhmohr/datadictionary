...
#' @keywords do file
#' @export
#' @examples iris #Create a Stata do file and csv for iris dataset; attr(iris, "variable.labels") = c("Length of Sepal in centimeters", "Width of Sepal in centimeters", "Length of petal in centimeters", "Width of Petal in centimeters", "Species of iris"); attr(iris, "value.labels") = c(rep("", ncol(iris))); write.Stata(iris, tempcodefile="Irisreadin.do", datafile="Irisdata.csv")
#' DataDictionary()
